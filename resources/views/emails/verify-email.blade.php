{{--
    ...
    Renders inside the family layout (templates/nexo-mail): shell, header, footer
    and dark mode are shared; only the message is local.
...
<x-nexo-mail::layout
    ...
    :preheader="__('Confirm your address so you can publish events.')">
