...
// This tool has no confirm-password screen; verification.notice needs a signed-in
// user, so it answers with a redirect and authPages() leaves it out.
const AUTH_ROUTES = ['login', 'register', 'password.request', 'verification.notice'];
